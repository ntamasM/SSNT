...
function ssnt_my_options_callback($args)
{
    ...
    ?>
        ...
        case "email":
        ?>
            <input type="email" <?php echo isset($args['required']) ? 'required' : '' ?> size=<?php echo $args['size'] ?> pattern=".+@example\.com" name=<?php echo 'ssnt_' . $args['name'] ?> value="<?php echo isset($setting) ? esc_attr($setting) : ''; ?>">
<?php
            break;
    }
}
